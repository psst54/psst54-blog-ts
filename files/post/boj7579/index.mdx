...
N개의 앱 $A_1, ..., A_N$이 있다. 앱 $A_i$는 $m_i$의 메모리를 사용중이고, 이를 비활성한 후 다시 실행할 때 $c_i$의 비용이 든다. 이 중에서 몇 개를 비활성화시켜 M 이상의 메모리를 확보하는 동시에, $c_i$의 합을 최소로 만드는 문제이다.

$
1 \leq N \leq 100 \newline
1 \leq M \leq 10,000,000 \newline
1 \leq m_1, ..., m_N \leq 10,000,000 \newline
0 \leq c_1, ..., c_N \leq 100 \newline
M \leq m_1 + m_2 + ... + m_N
$
